...
## Notas:
En una página para identificar cifrados ([https://www.dcode.fr/cipher-identifier](https://www.dcode.fr/cipher-identifier)) encontré que el código está cifrado con el Cifrado **Vigenère** usando como llave la palabra FLAG 
