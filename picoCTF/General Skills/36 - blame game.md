...
## Solución:
```
artacas-picoctf@webshell:~$ wget https://artifacts.picoctf.net/c_titan/157/challenge.zip
--2025-02-22 17:54:06--  https://artifacts.picoctf.net/c_titan/157/challenge.zip
...
2025-02-22 17:54:07 (1.92 MB/s) - 'challenge.zip' saved [293587/293587]
...
artacas-picoctf@webshell:~/drop-in$ git init
Reinitialized existing Git repository in /home/artacas-picoctf/drop-in/.git/
artacas-picoctf@webshell:~/drop-in$ git blame message.py

2466febd (picoCTF{@sk_th3_1nt3rn_cfca95b2} 2024-03-12 00:07:06 +0000 1) print("Hello, World!"
