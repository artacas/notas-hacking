...
## Solución:
```
artacas-picoctf@webshell:~$ nc verbal-sleep.picoctf.net 63159
...
Nyx beeps, "Message from Contact 0x36da"
...
"Ok, here's the message: Hey, looks like picoCTF 3025 registration opened up
early this year! I already created an account, I'll just send you my login info
and we can share an account. End of message. I'd recommend against that, Ei.
You can be disqualified for sharing an account and besides, don't you want to
know the challenges that *you* have completed yourself? Maybe you can suggest
to them that you will create a team so you can collaborate that way?"

---
(Press Enter to continue...)
---

"Thanks, Nyx, I appreciate the insight."
